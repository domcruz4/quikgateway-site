        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-600 shadow-sm transition hover:border-slate-300 hover:text-slate-800 hover:shadow"
            >
            ...
            <a
              ...
              className="rounded-full border border-slate-900 bg-slate-900 px-3 py-1.5 text-sm text-white shadow-sm transition hover:bg-slate-800"
            >
              Dashboard
            </a>
          </div>
